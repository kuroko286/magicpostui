      ...
      <Scrollbar sx={{ flexGrow: 1 }}>
        <Box sx={{ minWidth: 800 }}>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell>{transform ? "Mã vận chuyển" : "Mã đơn hàng"}</TableCell>
                <TableCell>{transform ? "Điểm vận chuyển" : "Điểm giao dịch"}</TableCell>
                <TableCell sortDirection="desc">
                  {transform ? "Điểm nhận hàng" : "Điểm tập kết"}
                </TableCell>
                <TableCell>{transform ? "Mã đơn hàng" : "Loại hàng"}</TableCell>
                ...
                : orders.map((order) => {
                    return (
                      <TableRow hover key={order.orderId}>
                        ...
                        <TableCell>{order.endLocation}</TableCell>
